...
.legend-box { display: flex; flex-wrap: wrap; gap: 12px; margin-bottom: 16px; padding: 8px 12px; background: #0c0a06; border: 1px solid #332d22; border-radius: 2px; font-size: 0.64rem; color: #807860; }
...
.metric-input { background: #0c0a06; color: #e0d8c8; border: 1px solid #332d22; padding: 8px 10px; border-radius: 2px; font-family: 'JetBrains Mono', monospace; font-size: 0.8rem; outline: none; transition: border-color 200ms ease; }
.metric-input:focus { border-color: #c9a84c; }

.analyze-btn { width: 100%; background: #5a4a2a; color: #d4c078; border: 1px solid #8a7030; padding: 12px; border-radius: 2px; font-weight: 700; font-family: 'Cinzel', serif; font-size: 0.78rem; letter-spacing: 2px; cursor: pointer; margin-bottom: 18px; transition: all 200ms ease; }
.analyze-btn:hover { background: #8a7030; color: #0c0a06; }
.analyze-btn:disabled { opacity: 0.25; cursor: default; }
...
.pareto-verdict { padding: 10px 14px; border-radius: 2px; font-size: 0.74rem; font-weight: 600; text-align: center; grid-column: 1 / -1; font-family: 'Cinzel', serif; letter-spacing: 1px; }
.pareto-verdict.is-pareto { background: rgba(90,158,111,0.08); border: 1px solid #5a9e6f; color: #5a9e6f; }
.pareto-verdict.not-pareto { background: rgba(196,75,60,0.08); border: 1px solid #c44b3c; color: #c44b3c; }

.target-info { background: #181510; border: 1px solid #5a4a2a; border-radius: 2px; padding: 10px 14px; font-size: 0.72rem; grid-column: 1 / -1; display: flex; gap: 8px; align-items: center; }
.target-label { color: #c9a84c; font-weight: 600; }
.target-score { color: #e0d8c8; }

.suggestions-box { background: #181510; border: 1px solid #332d22; border-radius: 2px; padding: 12px; grid-column: 1; }
...
.sug-row { display: flex; align-items: center; gap: 8px; padding: 5px 8px; border-bottom: 1px solid #221d17; font-size: 0.72rem; transition: background 150ms ease; }
...
.sug-gap.need-fix { color: #5a9e6f; }
.sug-gap.good { color: #5a5245; }

.chart-wrap { background: #181510; border: 1px solid #332d22; border-radius: 2px; padding: 12px; grid-column: 2; grid-row: 2 / 4; }
