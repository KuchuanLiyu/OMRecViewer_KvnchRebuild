...
.control-pair label { color: #807860; font-size: 0.66rem; }
.control-pair select { background: #0c0a06; color: #e0d8c8; border: 1px solid #332d22; padding: 4px 8px; border-radius: 2px; font-family: 'JetBrains Mono', monospace; font-size: 0.68rem; }
...
.hull-chart-wrap { background: #181510; border: 1px solid #332d22; border-radius: 2px; padding: 8px; }
.hull-chart { width: 100%; height: 420px; }

.weakness-panel { background: #181510; border: 1px solid #332d22; border-radius: 2px; padding: 10px; max-height: 440px; overflow-y: auto; }
.weakness-title { color: #c44b3c; font-size: 0.66rem; font-weight: 600; font-family: 'Cinzel', serif; letter-spacing: 1px; margin-bottom: 4px; }
.weakness-desc { color: #807860; font-size: 0.55rem; margin-bottom: 8px; line-height: 1.4; }
.weak-row { display: flex; align-items: center; gap: 6px; padding: 3px 0; border-bottom: 1px solid #221d17; font-size: 0.62rem; cursor: pointer; transition: background 150ms ease; }
.weak-row:hover, .weak-row.hovered { background: rgba(255,183,3,0.06); }
.weak-rank { color: #c44b3c; font-weight: 600; min-width: 30px; }
.weak-label { color: #e0d8c8; flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.weak-tag { background: rgba(196,75,60,0.15); color: #c44b3c; font-size: 0.55rem; padding: 1px 4px; border-radius: 2px; font-weight: 600; }
