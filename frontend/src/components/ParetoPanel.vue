...
.compare-toggle { background: none; border: 1px solid #5a4a2a; color: #c9a84c; font-family: 'Cinzel', serif; font-size: 0.62rem; padding: 3px 10px; border-radius: 2px; cursor: pointer; margin-left: auto; letter-spacing: 1px; transition: all 200ms ease; }
.compare-toggle.active { background: #5a4a2a; color: #0c0a06; }
.compare-toggle:hover { background: #5a4a2a; color: #0c0a06; }

.group-card { background: #181510; border: 1px solid #332d22; border-radius: 2px; margin-bottom: 6px; overflow: hidden; }
.group-header { display: flex; align-items: center; gap: 6px; padding: 7px 10px; cursor: pointer; user-select: none; font-size: 0.7rem; transition: background 150ms ease; }
.group-header:hover { background: #1f1b14; }
.group-arrow { color: #807860; font-size: 0.5rem; }
.group-sig { color: #5a9e6f; font-weight: 600; }
.group-count { color: #c9a84c; font-size: 0.64rem; }
.group-desc { color: #807860; font-size: 0.6rem; }
.group-body { border-top: 1px solid #221d17; padding: 4px 10px 6px; }

.entry-row { display: grid; grid-template-columns: 260px 1fr 90px; align-items: center; gap: 8px; padding: 3px 0; border-bottom: 1px solid #221d17; font-size: 0.66rem; cursor: pointer; transition: background 150ms ease; }
.entry-row:hover { background: rgba(201,168,76,0.03); }
.entry-row.selected { background: rgba(201,168,76,0.06); border-color: #5a4a2a; }
...
.tip-badge { background: rgba(90,158,111,0.1); color: #e0d8c8; border: 1px solid rgba(90,158,111,0.2); border-radius: 2px; padding: 1px 4px; font-size: 0.58rem; white-space: nowrap; }
.tip-delta { color: #5a9e6f; font-weight: 600; }
.tip-none { color: #5a9e6f; font-size: 0.58rem; }
.entry-upgrades { display: flex; gap: 3px; justify-content: flex-end; }
.upgrade-tag { color: #e0d8c8; font-size: 0.58rem; background: rgba(201,168,76,0.08); border: 1px solid rgba(201,168,76,0.2); border-radius: 2px; padding: 1px 4px; white-space: nowrap; }

.compare-panel { margin: 5px 0 8px; padding: 8px 10px; background: #0c0a06; border: 1px solid #5a4a2a; border-radius: 2px; }
.compare-title { color: #c9a84c; font-size: 0.64rem; font-weight: 600; font-family: 'Cinzel', serif; letter-spacing: 1px; margin-bottom: 5px; }
.compare-table { width: 100%; border-collapse: collapse; font-size: 0.62rem; margin-bottom: 6px; }
.compare-table th { color: #807860; font-weight: 400; padding: 2px 4px; border-bottom: 1px solid #332d22; text-align: center; font-family: 'Cinzel', serif; letter-spacing: 1px; }
.compare-table th:first-child { text-align: left; }
.compare-table td { padding: 2px 4px; border-bottom: 1px solid #221d17; text-align: center; }
...
.col-up { color: #5a9e6f; font-size: 0.6rem; }
.delta { color: #5a9e6f; font-size: 0.58rem; font-weight: 600; }
.keep { color: #3a3228; font-size: 0.6rem; }

.compare-floating { position: sticky; top: 8px; z-index: 50; background: #181510; border: 1px solid #5a4a2a; border-radius: 2px; padding: 10px 12px; margin-bottom: 10px; }
...
.compare-floating-header button { background: none; border: 1px solid #332d22; color: #807860; cursor: pointer; font-size: 0.9rem; padding: 0 5px; border-radius: 2px; transition: all 200ms ease; }
.compare-floating-header button:hover { color: #c44b3c; border-color: #c44b3c; }
.compare-floating-table { width: 100%; border-collapse: collapse; font-size: 0.66rem; margin-bottom: 6px; }
.compare-floating-table th { color: #807860; font-weight: 400; padding: 2px 6px; border-bottom: 1px solid #332d22; text-align: center; font-family: 'Cinzel', serif; letter-spacing: 1px; }
.compare-floating-table th:first-child { text-align: left; }
.compare-floating-table td { padding: 2px 6px; border-bottom: 1px solid #221d17; text-align: center; }
.c-a { color: #c9a84c; }
.c-b { color: #b87333; }
.delta-good { color: #5a9e6f; font-weight: 600; }
.delta-bad { color: #c44b3c; font-weight: 600; }
